...
denotes the joint distribution over prompt-response pairs, and

$$
\mathcal{D}_{U}
$$

denotes its marginal distribution over prompts. Thus, a sample from the SFT distribution is a pair
