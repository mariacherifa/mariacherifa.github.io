...
<div class="rlhf-roadmap">
  <div class="roadmap-step">
    <div class="step-number">1</div>
    <div class="step-text">
      Introduce preference data
    </div>
  </div>
  ...
  <div class="roadmap-step">
    ...
    <div class="step-text">
      Interpret RLHF as constrained optimization
    </div>
  </div>
  ...
  <div class="roadmap-step">
    ...
    <div class="step-text">
      Explain policy-gradient methods and PPO
    </div>
  </div>
</div>
...
A_t>0
\quad \Rightarrow \quad
\text{increase the probability of } a_t,
$$
...
A_t<0
\quad \Rightarrow \quad
\text{decrease the probability of } a_t.
$$
